...
!
      ...
      real(dble)   rncut2      !square of nuclear interaction cutoff radius
      ...
      ytmp=0.0d0
      xtmp=0.0d0
      !$omp parallel private(xx,r2,r,expfac)
      do 100 i=myrank,n-2,nprocs
        ...
        do 90 j=i+1,n-1
          ...
          do k=1,3
            ...
            r2=r2+xx*xx
          enddo
          if(nuclear_on .and. r2.le.rncut2) then
            ...
            xtmp(2) = xtmp(2) + (r2*xpacketi)*(2.*aa*expfac+xbbcc)*expfac  !virial
          endif
          if(coulomb_on .and. r2.le.rccut2) then
...
! potential energy, virial and pressure tensor in addition to all the forces.
      ...
      !$omp parallel private(xx,r2,r,expfac,xbbcc,fn,fc,fncx,fzero)
      do 100 i=myrank,n-2,nprocs
      ...
      do 200 i=myrank,n-2,nprocs
        ...
        do 190 j=i+1,n-1
          ...
          if(coulomb_on .and. r2.le.rccut2) then
            if((zii(i).eq.1.d0).and.(zii(j).eq.1.d0)) then   !p-p
              r=sqrt(r2)
              fc = vc*(1.+xmuc*r)*exp(-xmuc*r)/(r*r2)
              fzero=.false.
            endif
          endif
          if(.not.fzero) then
